...
-(id)initWithFrame:(CGRect)frame withImageView:(NSMutableArray *)imageviewarr
{
    ...
    for (int i=0; i<pageCount; i++) {
        ...
        HdImageView *imageview=[imageviewarr objectAtIndex:i];
    ...
    NSLog(@"%ld",(long)self.pagecontrol.numberOfPages);
...
-(id)initLoopScrollWithFrame:(CGRect)frame withImageView:(NSMutableArray *)ArrImageView
{
    ...
    //深拷贝imageview上的控件
    HdImageView *imageview1=[ArrImageView objectAtIndex:([ArrImageView count]-1)];
    HdImageView *imageview2=[ArrImageView objectAtIndex:0];
    ...
    HdImageView *imageview3=[NSKeyedUnarchiver unarchiveObjectWithData:data1];
    HdImageView *imageview4=[NSKeyedUnarchiver unarchiveObjectWithData:data2];
    ...
    for (int i=0; i<pageCount; i++) {
        bounds.origin.x=bounds.size.width*i;
        HdImageView *imageview=[tempArray objectAtIndex:i];
        imageview.userInteractionEnabled=YES;
        imageview.frame=bounds;
        [self addSubview:imageview];
    }
