...
- (instancetype)initWithFrame:(CGRect)frame {
    return [self initWithFrame:frame numberOfStars:DEFALUT_STAR_NUMBER fullImg:nil emptyImg:nil];
}
...
- (void)buildDataAndUI {
    ...
    self.foregroundStarView = [self createStarViewWithImage:_fullImg];
    self.backgroundStarView = [self createStarViewWithImage:_emptyImg];
...
- (UIView *)createStarViewWithImage:(UIImage *)img {
...
- (void)setScorePercent:(CGFloat)scroePercent {
    ...
    if (_resultBlock) {
        _resultBlock(_numberOfStars*scroePercent,scroePercent);
    }
