...
#pragma clang diagnostic pop
        ...
        self.circleViewBackground.backgroundColor=[UIColor clearColor];
...
//        NSLog(@"222 %@",navigationController.interactivePopGestureRecognizer);
//        _restoreInteractivePopGestureDelegate = navigationController.interactivePopGestureRecognizer.delegate;
//        NSLog(@"333  %@",_restoreInteractivePopGestureDelegate);
